...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		// 3
		JButton[] buttons = new JButton[id];
		...
		JOptionPane.showMessageDialog(null, "Instructions: look for the button that said me. That's all :)");
		// 13. initialize the hiddenButton variable to a random number less than the int
		// created int step 3
		hiddenButton = new Random().nextInt(id);
